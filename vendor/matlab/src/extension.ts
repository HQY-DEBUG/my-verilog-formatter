        ...
        const clientOptions: LanguageClientOptions = {
            ...
            middleware: {
                provideDocumentFormattingEdits: (document, options, token, next) =>
                    vscode.workspace.getConfiguration('MATLAB').get<string>('formatter', 'hanxuyao') === 'mathworks'
...
function getServerArgs (): string[] {
    ...
    const args = [
        ...
        `--matlabConnectionTiming=${configuration.get<string>('matlabConnectionTiming') ?? 'onDemand'}`,
