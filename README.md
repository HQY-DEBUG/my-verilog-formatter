...
```bash
npm run package -- --target win32-x64 --out hanxuyao-plugin-1.4.8-win32-x64.vsix
code --install-extension hanxuyao-plugin-1.4.8-win32-x64.vsix --force
```
